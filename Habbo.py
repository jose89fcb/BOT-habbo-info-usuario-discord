...
async def HabboES(ctx, *, Habboinfo):
    async with ctx.typing():
        ...
        response = requests.get(
            f"https://www.habbo.es/api/public/users?name={Habboinfo}"
        )
        ...
        embed = discord.Embed(
            ...
            + (
                str(NivelActual)
                + "\n\n•Total placas🡺 "
                + ("{:,}".format(placas)).replace(",", ".")
                + "\n\n•Total Amigos🡺 "
                + ("{:,}".format(amigos)).replace(",", ".")
                + "\n\n•Fotos Totales🡺 "
                + (str(fotos))
                + "\n\n•Gemas Obtenidas (Estrellas)🡺 "
                + ("{:,}".format(GemasHabbo)).replace(",", ".")
                + "\n\n•Total XP🡺 "
            )
            + ("{:,}".format(TotalXP)).replace(",", ".")
            + "\n\n•Siguiente nivel🡺 "
            + (str(siguientenivel))
            + "\n\n•Salas totales🡺 "
            + (str(salas))
            ...
            + "\n\n[Visita el perfil de "
            + Habbokeko
            + "](https://habbo.es/profile/"
            + Habbokeko
            + ")"
            "\n\n[twitter oficial](https://twitter.com/ESHabbo) | "
            "[facebook oficial](https://www.facebook.com/Habbo) | "
            "[instagram oficial](https://www.instagram.com/habboofficial)",
            timestamp=datetime.datetime.utcnow(),
            color=discord.Colour.random(),
        )
        embed.set_thumbnail(
            url="https://www.habbo.es/habbo-imaging/avatarimage?user="
            + Habbokeko
            + "&&headonly=1&size=b&gesture=sml&head_direction=4&action=std"
        )
...
async def HabboCOM(ctx, *, Habboinfo):
    async with ctx.typing():
        ...
        response = requests.get(
            f"https://www.habbo.com/api/public/users?name={Habboinfo}"
        )
        Habboinfo = response.json()["uniqueId"]
        ...
        embed = discord.Embed(
            ...
            + "\n\n[Visita el perfil de "
            + Habbokeko
            + "](https://habbo.com/profile/"
            + Habbokeko
            + ")"
            "\n\n[twitter oficial](https://twitter.com/Habbo) | "
            "[facebook oficial](https://www.facebook.com/Habbo) | "
            "[instagram oficial](https://www.instagram.com/habboofficial)",
            timestamp=datetime.datetime.utcnow(),
            color=discord.Colour.random(),
        ...
        embed.set_thumbnail(
            url="https://www.habbo.com/habbo-imaging/avatarimage?user="
            + Habbokeko
            + "&&headonly=1&size=b&gesture=sml&head_direction=4&action=std"
        )
...
async def HabboDE(ctx, *, Habboinfo):
    async with ctx.typing():
        ...
        response = requests.get(
            f"https://www.habbo.de/api/public/users?name={Habboinfo}"
        )
        Habboinfo = response.json()["uniqueId"]
        ...
        embed = discord.Embed(
            ...
            + "\n\n[Visita el perfil de "
            + Habbokeko
            + "](https://habbo.de/profile/"
            + Habbokeko
            + ")"
            "\n\n[twitter oficial](https://twitter.com/De_Habbo) | "
            "[facebook oficial](https://www.facebook.com/Habbo) | "
            "[instagram oficial](https://www.instagram.com/habboofficial)",
            timestamp=datetime.datetime.utcnow(),
            color=discord.Colour.random(),
        ...
        embed.set_thumbnail(
            url="https://www.habbo.de/habbo-imaging/avatarimage?user="
            + Habbokeko
            + "&&headonly=1&size=b&gesture=sml&head_direction=4&action=std"
        )
...
async def HabboFR(ctx, *, Habboinfo):
    async with ctx.typing():
        ...
        response = requests.get(
            f"https://www.habbo.fr/api/public/users?name={Habboinfo}"
        )
        Habboinfo = response.json()["uniqueId"]
        ...
        embed = discord.Embed(
            ...
            + "\n\n[Visita el perfil de "
            + Habbokeko
            + "](https://habbo.fr/profile/"
            + Habbokeko
            + ")"
            "\n\n[twitter oficial](https://twitter.com/HabboFR) | "
            "[facebook oficial](https://www.facebook.com/Habbo) | "
            "[instagram oficial](https://www.instagram.com/habboofficial)",
            timestamp=datetime.datetime.utcnow(),
            color=discord.Colour.random(),
        ...
        embed.set_thumbnail(
            url="https://www.habbo.fr/habbo-imaging/avatarimage?user="
            + Habbokeko
            + "&&headonly=1&size=b&gesture=sml&head_direction=4&action=std"
        )
...
async def HabboFI(ctx, *, Habboinfo):
    async with ctx.typing():
        ...
        response = requests.get(
            f"https://www.habbo.fi/api/public/users?name={Habboinfo}"
        )
        Habboinfo = response.json()["uniqueId"]
        ...
        embed = discord.Embed(
            ...
            + "\n\n[Visita el perfil de "
            + Habbokeko
            + "](https://habbo.fi/profile/"
            + Habbokeko
            + ")"
            "\n\n[twitter oficial](https://twitter.com/HabboFi) | "
            "[facebook oficial](https://www.facebook.com/Habbo) | "
            "[instagram oficial](https://www.instagram.com/habboofficial)",
            timestamp=datetime.datetime.utcnow(),
            color=discord.Colour.random(),
        ...
        embed.set_thumbnail(
            url="https://www.habbo.fi/habbo-imaging/avatarimage?user="
            + Habbokeko
            + "&&headonly=1&size=b&gesture=sml&head_direction=4&action=std"
        )
...
async def HabboIT(ctx, *, Habboinfo):
    async with ctx.typing():
        ...
        response = requests.get(
            f"https://www.habbo.it/api/public/users?name={Habboinfo}"
        )
        Habboinfo = response.json()["uniqueId"]
        ...
        embed = discord.Embed(
            ...
            + "\n\n[Visita el perfil de "
            + Habbokeko
            + "](https://habbo.it/profile/"
            + Habbokeko
            + ")"
            "\n\n[twitter oficial](https://twitter.com/HabboItalia) | "
            "[facebook oficial](https://www.facebook.com/Habbo) | "
            "[instagram oficial](https://www.instagram.com/habboofficial)",
            timestamp=datetime.datetime.utcnow(),
            color=discord.Colour.random(),
        ...
        embed.set_thumbnail(
            url="https://www.habbo.it/habbo-imaging/avatarimage?user="
            + Habbokeko
            + "&&headonly=1&size=b&gesture=sml&head_direction=4&action=std"
        )
...
async def HabboTR(ctx, *, Habboinfo):
    async with ctx.typing():
        ...
        response = requests.get(
            f"https://www.habbo.com.tr/api/public/users?name={Habboinfo}"
        )
        Habboinfo = response.json()["uniqueId"]
        ...
        embed = discord.Embed(
            ...
            + "\n\n[Visita el perfil de "
            + Habbokeko
            + "](https://habbo.com.tr/profile/"
            + Habbokeko
            + ")"
            "\n\n[twitter oficial](https://twitter.com/habbo_tr) | "
            "[facebook oficial](https://www.facebook.com/Habbo) | "
            "[instagram oficial](https://www.instagram.com/habboofficial)",
            timestamp=datetime.datetime.utcnow(),
            color=discord.Colour.random(),
        ...
        embed.set_thumbnail(
            url="https://www.habbo.com.tr/habbo-imaging/avatarimage?user="
            + Habbokeko
            + "&&headonly=1&size=b&gesture=sml&head_direction=4&action=std"
        )
...
async def HabboNL(ctx, *, Habboinfo):
    async with ctx.typing():
        ...
        response = requests.get(
            f"https://www.habbo.nl/api/public/users?name={Habboinfo}"
        )
        Habboinfo = response.json()["uniqueId"]
        ...
        embed = discord.Embed(
            ...
            + "\n\n[Visita el perfil de "
            + Habbokeko
            + "](https://habbo.nl/profile/"
            + Habbokeko
            + ")"
            "\n\n[twitter oficial](https://twitter.com/Habbo_Staff) | "
            "[facebook oficial](https://www.facebook.com/Habbo) | "
            "[instagram oficial](https://www.instagram.com/habboofficial)",
            timestamp=datetime.datetime.utcnow(),
            color=discord.Colour.random(),
        ...
        embed.set_thumbnail(
            url="https://www.habbo.nl/habbo-imaging/avatarimage?user="
            + Habbokeko
            + "&&headonly=1&size=b&gesture=sml&head_direction=4&action=std"
        )
...
async def HabboBR(ctx, *, Habboinfo):
    async with ctx.typing():
        ...
        response = requests.get(
            f"https://www.habbo.com.br/api/public/users?name={Habboinfo}"
        )
        Habboinfo = response.json()["uniqueId"]
        ...
        embed = discord.Embed(
            ...
            + "\n\n[Visita el perfil de "
            + Habbokeko
            + "](https://habbo.com.br/profile/"
            + Habbokeko
            + ")"
            "\n\n[twitter oficial](https://twitter.com/HabboPTBR) | "
            "[facebook oficial](https://www.facebook.com/Habbo) | "
            "[instagram oficial](https://www.instagram.com/habboofficial)",
            timestamp=datetime.datetime.utcnow(),
            color=discord.Colour.random(),
        ...
        embed.set_thumbnail(
            url="https://www.habbo.com.br/habbo-imaging/avatarimage?user="
            + Habbokeko
            + "&&headonly=1&size=b&gesture=sml&head_direction=4&action=std"
        )
...
async def cerrar(ctx):
    embed = discord.Embed(
        title=f" ",
        description="él BOT **" + bot.user.name + "** ahora está desconectado",
...
async def on_ready():
    ...
    embed = discord.Embed(
        ...
        + bot.user.name
        + "** ahora está en linea"
        + "\n\nEscribe !comandos para conocer los comandos de cada hotel",
...
async def comandos(ctx):
    embed = discord.Embed(
        title="COMANDOS",
        description="Aquí están todos los comandos para poder generar los usuarios de cada hotel\n\n!HabboES ejemplo\n!HabboCOM ejemplo\n!HabboDE ejemplo\n!HabboFR ejemplo\n!HabboFI ejemplo\n!HabboIT ejemplo\n!HabboTR ejemplo\n!HabboNL ejemplo\n!HabboBR ejemplo\n\n\nEscribe !cerrar para poder cerrar el bot",
    )
